...
import { threeHorizontalDotsIcon,timerIcon } from "@/components/constants";
...
const CardComponent = ({
  ...
  return (
    <div className="w-full min-h-[200px] bg-[#070519] rounded-[16px] relative">
      <div className="flex flex-col gap-5 w-full min-h-[200px] p-3 bg-[#211a75] rounded-[16px]">
